...
verify_envs() {
	if [ -z "$MYSQL_ROOT_PASSWD" -o -z "$MYSQL_USER" -o -z "$MYSQL_USER_PASSWD" -o -z "$MYSQL_DATABASE" -o -z "$MYSQL_GITEA_USER" -o -z "$MYSQL_GITEA_PASSWD" -o -z "$MYSQL_GITEA_DATABASE" ]; then
		cat <<- 'EOF'
